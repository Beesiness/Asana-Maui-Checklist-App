...
namespace Asana.Library.Services
{
    public class ToDoServiceProxy
    {
        ...
        private ToDoServiceProxy()
        {
            ToDos = new List<ToDo>
            {
                new ToDo{Id = 1, Name = "Task 1", Description = "My Task 1", IsCompleted=true, DueDate = new DateTime(2025, 12, 31)},
                new ToDo{Id = 2, Name = "Task 2", Description = "My Task 2", IsCompleted=false, DueDate = new DateTime(2014, 1, 24)},
        ...
        //This is for logging the data and is being used for debugging purposes with Import
        public void LogToDos()
        {
