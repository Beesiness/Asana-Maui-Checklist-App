...
namespace Asana.Maui.ViewModels
{
    public class ToDoDetailViewModel
    {
        ...
        public ToDoDetailViewModel(ToDo? model)
        {
            ...
            DeleteCommand = new Command(DoDelete);
            RemoveFromProjectCommand = new Command(RemoveFromProject);
        }
        ...
        public ICommand? RemoveFromProjectCommand { get; set; }
        ...
        {
            if (Model != null && Model.ProjectId.HasValue)
            {
                Model.ProjectId = null; //Remove the Project assignment
                foreach (var project in ProjectServiceProxy.Current.Projects)
                {
                    if (project.ToDos.Contains(Model))
                    {
